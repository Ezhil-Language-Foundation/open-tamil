...
class BasicTamilTimeFormat:
    ...
    def format(year,month,month_day,week_day,hour,minute,second):
        return " ".join([DateUtils.tamil_month(month), str(week_day), DateUtils.tamil_weekday(week_day),
        DateUtils.get_hour_prefix(hour),str(minute),str(second)])
...
TamilLunarMonths = list(zip(["சித்திரை","வைகாசி","ஆனி","ஆடி","ஆவணி","புரட்டாசி",
"ஐப்பசி","கார்த்திகை",
"மார்கழி","தை","மாசி","பங்குனி"],[30,31,31,31,31,30,29,29,29,29,29,30]))

TamilSeasonsMonths = {"இளவேனில்":["சித்திரை","வைகாசி"],
"கோடை":["ஆனி","ஆடி"],
"கார்":["ஆவணி","புரட்டாசி"],
