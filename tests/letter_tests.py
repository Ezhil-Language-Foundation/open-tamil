...
class Arichuvadi(unittest.TestCase):
    ...
    def test_assertions(self):
        ...
        self.assertEqual(
            tamil.utf8.TA_GRANTHA_UYIRMEI_LEN, len(tamil.utf8.grantha_uyirmei_letters)
        )
...
class Letters(unittest.TestCase):
    ...
    def test_mei_vaggupu(self):
        vaguppu = list()
        for cat in [
            utf8.vallinam_letters,
            utf8.mellinam_letters,
            utf8.idayinam_letters,
        ]:
...
class CodecTSCII(unittest.TestCase):
    ...
    def test_basic_lookup2UTF8(self):
        TSCII = tamil.tscii.TSCII
        self.assertEqual(
            TSCII[0xAB] + TSCII[0xF4] + TSCII[0xC0] + TSCII[0xA1], u"அப்பா"
        )
