...
class NumeralToNumberTests(unittest.TestCase):
    ...
    def test_parse(self):
        ...
        self.assertEqual(
            tamilstr2num("நூற்றி இரண்டு ஆயிரத்து நாநூற்று பத்து".split(" ")), 102410.0
        )
        ...
        self.assertEqual(
            tamilstr2num("ஓர் ஆயிரத்து அறுநூற்று ஒன்பது".split(" ")), 1000 + 600 + 9
        )
    ...
    def test_parse_USA(self):
        self.assertEqual(
            tamilstr2num(["ஒரு", "மில்லியன்", "பத்து", "ஆயிரம்"]), 1e6 + 1e4
        )
        self.assertEqual(
            tamilstr2num(["ஒரு", "மில்லியன்", "ஆயிரம்", "புள்ளி", "ஐந்து"]), 1001000.5
        )
...
class NumeralStringLimitTests(unittest.TestCase):
    def test_case_basic(self):
        ...
        self.assertEqual(
            u"புள்ளி ஒன்பது எட்டு ஏழு ஆறு", tamil.numeral.num2tamilstr("0.9876")
        )

    def test_case_american(self):
        self.assertEqual(
            u"புள்ளி மூன்று மூன்று", tamil.numeral.num2tamilstr_american("0.33")
        )
        self.assertEqual(
            u"புள்ளி ஒன்பது எட்டு ஏழு ஆறு",
            tamil.numeral.num2tamilstr_american("0.9876"),
        )
...
class NumeralTestAmerican(unittest.TestCase):
    ...
    def test_basic_pulli(self):
        numerals = (
            u"புள்ளி ஐந்து",
            u"ஒன்று புள்ளி ஐந்து",
            u"இரண்டு புள்ளி ஐந்து",
            u"மூன்று புள்ளி ஐந்து",
            u"நான்கு புள்ளி ஐந்து",
            u"ஐந்து புள்ளி ஐந்து",
            u"ஆறு புள்ளி ஐந்து",
            u"ஏழு புள்ளி ஐந்து",
            u"எட்டு புள்ளி ஐந்து",
            u"ஒன்பது புள்ளி ஐந்து",
            u"பத்து புள்ளி ஐந்து",
        )
    ...
    def test_numerals(self):
        var = {
            ...
            int(
                1e9 - 1
            ): u"தொள்ளாயிரத்து தொன்னூற்றொன்பது மில்லியன் தொள்ளாயிரத்து தொன்னூற்றொன்பது ஆயிரத்து தொள்ளாயிரத்து தொன்னூற்றொன்பது",
            3060: u"மூன்று ஆயிரத்து அறுபது",
            1: u"ஒன்று",
            2: u"இரண்டு",
            3: u"மூன்று",
